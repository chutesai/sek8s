...
class DeviceInfo(BaseModel):
    ...
    name: str = Field(
        ..., description="Full GPU product name, e.g., 'NVIDIA RTX A6000'"
    )
    ...
    class Config:
        json_encoders = {UUID: str}  # Ensure UUIDs serialize as strings
...
class GPU(BaseModel):
    ...
    model_short_ref: str = Field(
        ..., description="Short reference for GPU model, e.g., 'a6000'"
    )
