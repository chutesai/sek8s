...
class GpuDeviceProvider:
        ...
        try:
            ...
            for i in range(device_count):
                ...
                device_info = DeviceInfo(
                    ...
                    clock_rate=pynvml.nvmlDeviceGetMaxClockInfo(
    ...
    def _filter_device_info(
        self, all_devices: list[DeviceInfo], target_gpu_ids: Optional[list[str]]
    ):
        ...
        if target_gpu_ids:
            ...
            if formatted_uuids:
                filtered_devices = [
                    gpu for gpu in all_devices if gpu.uuid in formatted_uuids
                ]
